...
const btn = document.getElementById("rot12").addEventListener("click",()=>{
  ...
  if(uiCntnt)uiCntnt.innerText=injctn13(uiCntnt.innerText,rShift);
});
...
injctn13(btn);//my hunch is that this value should be linked to the values selected by user, from dropdown, and then the text on screen, should be shifted according to that value.
